functie()
{
	...
	cat /etc/issue.net //arata elementele fara a deschide fisierul 
	echo "Numarul de secunde de la executie: "
	$SECONDS
	echo "Calea curenta: "
	pwd //print the path of curent directory
	echo "\n"
}
...
{
	echo "\n"
	awk "FNR>=2 && FNR<=3" /etc/shells //arata coloanele 
	echo "\n"
}
...
{
	echo "\n"
	tail -n 9 /etc/protocols //printeaza ultimele 10 linii dintr-un fisier
	echo "\n"	
}
...
functie5()
{
	...
	grep "cache size" /proc/cpuinfo // cauta cuvantul in fisier si afiseaza randul
	echo "\n"
